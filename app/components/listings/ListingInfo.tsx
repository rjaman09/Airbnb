    ...
    <div className="col-span-4 flex flex-col gap-8">
      <div className="flex flex-col gap-2">
        <div className="text-xl font-semibold flex flex-row items-center gap-2">
          <div className="tracking-wide">Hosted by {user?.name}</div>
          <Avatar src={user?.image} />
        </div>

        <div className="flex flex-row items-center gap-4 font-light text-neutral-500">
          <div className="tracking-wide">{guestCount} guests</div>
          <div className="tracking-wide">{roomCount} rooms</div>
          <div className="tracking-wide">{bathroomCount} bathrooms</div>
        </div>
      </div>
