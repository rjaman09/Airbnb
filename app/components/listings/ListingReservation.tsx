  ...
  return (
    <div className="bg-white rounded-xl border-[1px] border-neutral-200 overflow-hidden">
      <div className="flex flex-row items-center gap-1 p-4">
        ...
        <div className="font-light text-neutral-600 tracking-wide">
          night
        </div>
      </div>
      ...
      <div className="p-4 flex flex-row items-center justify-between font-semibold tracking-wide text-lg">
        <div>Total</div>
        <div>$ {totalPrice}</div>
      </div>
    </div>
